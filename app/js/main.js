...
(function () {
  ...
  if (heroBtn) {
    if (os === "windows") {
      heroBtn.setAttribute("href", "https://github.com/CredentAppDev/credent-website/releases/download/v1.6.6/Credent-Setup-1.6.6.exe");
      ...
      heroBtn.setAttribute("href", "https://github.com/CredentAppDev/credent-website/releases/download/v1.6.6/Credent-1.6.6-arm64.dmg");
      heroBtn.setAttribute("download", "");
