...
(function () {
  ...
  if (heroBtn) {
    if (os === "windows") {
      heroBtn.setAttribute("href", "https://github.com/CredentAppDev/credent-website/releases/download/v1.6.21/Credent-Setup-1.6.21.exe");
      ...
      heroBtn.setAttribute("href", "https://github.com/CredentAppDev/credent-website/releases/download/v1.6.21/Credent-1.6.21-arm64.dmg");
      heroBtn.setAttribute("download", "");
